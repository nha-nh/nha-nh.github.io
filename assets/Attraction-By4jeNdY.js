import{H as m,f as o,ah as ee,ai as te,G as oe,g as P,I as K,d as G,aJ as re,h as s,O as ne,by as le,j as se,K as Z,dn as ie,M as ae,n as L,cT as de,R as E,z as ce,X as be,o as U,u as i,a8 as pe,au as ge,p as J,bF as he,w as b,af as W,b as u,e as h,c as fe,ad as me,U as ue,P as ve,t as x,bI as F,_ as ye}from"./index-BQf8aFpZ.js";import{N as j}from"./a-Lzm8mlLn.js";function X(t,p="default",c=[]){const{children:a}=t;if(a!==null&&typeof a=="object"&&!Array.isArray(a)){const d=a[p];if(typeof d=="function")return d()}return c}const we=m([o("descriptions",{fontSize:"var(--n-font-size)"},[o("descriptions-separator",`
