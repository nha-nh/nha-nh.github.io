import{l as Ze,cG as Ue,z as be,m as fn,d as pe,h as i,cH as Oe,v as hn,cI as en,x as Ge,aX as Un,aO as vn,f as x,I as M,g as U,H as ne,G as Xe,c0 as gn,bn as on,cJ as Gn,S as qn,A as Qn,j as nn,aj as bn,K as Fe,y as j,cK as Jn,p as S,M as tn,n as P,cL as Ie,cM as Xn,E as pn,cm as Yn,R as ge,cN as Be,F as ln,cO as Zn,cP as et,aq as qe,cQ as rn,P as nt,bA as tt,cR as ot,aQ as lt,c1 as it,c2 as rt,c3 as at,c4 as Ye,aM as st,aN as dt,c5 as an,cS as ut,aP as sn,c6 as ct,c8 as ft,aU as ht,cT as vt,cU as gt,a$ as ee,cV as bt}from"./index-DeO2nFEY.js";import{N as pt}from"./Suffix-Bgvv0tmC.js";import{g as dn}from"./attribute-Cz32yFEB.js";import{V as mt,N as wt}from"./Empty-4ZDCo0fx.js";import{u as yt}from"./use-locale-DCloiDkB.js";function mn(e,a){a&&(Ze(()=>{const{value:s}=e;s&&Ue.registerHandler(s,a)}),be(e,(s,d)=>{d&&Ue.unregisterHandler(d)},{deep:!1}),fn(()=>{const{value:s}=e;s&&Ue.unregisterHandler(s)}))}function Qe(e){const a=e.filter(s=>s!==void 0);if(a.length!==0)return a.length===1?a[0]:s=>{e.forEach(d=>{d&&d(s)})}}const xt=pe({name:"Checkmark",render(){return i("svg",{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 16 16"},i("g",{fill:"none"},i("path",{d:"M14.046 3.486a.75.75 0 0 1-.032 1.06l-7.93 7.474a.85.85 0 0 1-1.188-.022l-2.68-2.72a.75.75 0 1 1 1.068-1.053l2.234 2.267l7.468-7.038a.75.75 0 0 1 1.06.032z",fill:"currentColor"})))}}),Ct=pe({props:{onFocus:Function,onBlur:Function},setup(e){return()=>i("div",{style:"width: 0; height: 0",tabindex:0,onFocus:e.onFocus,onBlur:e.onBlur})}}),un=pe({name:"NBaseSelectGroupHeader",props:{clsPrefix:{type:String,required:!0},tmNode:{type:Object,required:!0}},setup(){const{renderLabelRef:e,renderOptionRef:a,labelFieldRef:s,nodePropsRef:d}=hn(en);return{labelField:s,nodeProps:d,renderLabel:e,renderOption:a}},render(){const{clsPrefix:e,renderLabel:a,renderOption:s,nodeProps:d,tmNode:{rawNode:f}}=this,v=d==null?void 0:d(f),h=a?a(f,!1):Oe(f[this.labelField],f,!1),r=i("div",Object.assign({},v,{class:[`${e}-base-select-group-header`,v==null?void 0:v.class]}),h);return f.render?f.render({node:r,option:f}):s?s({node:r,option:f,selected:!1}):r}});function Ot(e,a){return i(vn,{name:"fade-in-scale-up-transition"},{default:()=>e?i(Un,{clsPrefix:a,class:`${a}-base-select-option__check`},{default:()=>i(xt)}):null})}const cn=pe({name:"NBaseSelectOption",props:{clsPrefix:{type:String,required:!0},tmNode:{type:Object,required:!0}},setup(e){const{valueRef:a,pendingTmNodeRef:s,multipleRef:d,valueSetRef:f,renderLabelRef:v,renderOptionRef:h,labelFieldRef:r,valueFieldRef:z,showCheckmarkRef:A,nodePropsRef:O,handleOptionClick:E,handleOptionMouseEnter:R}=hn(en),C=Ge(()=>{const{value:T}=s;return T?e.tmNode.key===T.key:!1});function w(T){const{tmNode:F}=e;F.disabled||E(T,F)}function _(T){const{tmNode:F}=e;F.disabled||R(T,F)}function K(T){const{tmNode:F}=e,{value:k}=C;F.disabled||k||R(T,F)}return{multiple:d,isGrouped:Ge(()=>{const{tmNode:T}=e,{parent:F}=T;return F&&F.rawNode.type==="group"}),showCheckmark:A,nodeProps:O,isPending:C,isSelected:Ge(()=>{const{value:T}=a,{value:F}=d;if(T===null)return!1;const k=e.tmNode.rawNode[z.value];if(F){const{value:D}=f;return D.has(k)}else return T===k}),labelField:r,renderLabel:v,renderOption:h,handleMouseMove:K,handleMouseEnter:_,handleClick:w}},render(){const{clsPrefix:e,tmNode:{rawNode:a},isSelected:s,isPending:d,isGrouped:f,showCheckmark:v,nodeProps:h,renderOption:r,renderLabel:z,handleClick:A,handleMouseEnter:O,handleMouseMove:E}=this,R=Ot(s,e),C=z?[z(a,s),v&&R]:[Oe(a[this.labelField],a,s),v&&R],w=h==null?void 0:h(a),_=i("div",Object.assign({},w,{class:[`${e}-base-select-option`,a.class,w==null?void 0:w.class,{[`${e}-base-select-option--disabled`]:a.disabled,[`${e}-base-select-option--selected`]:s,[`${e}-base-select-option--grouped`]:f,[`${e}-base-select-option--pending`]:d,[`${e}-base-select-option--show-checkmark`]:v}],style:[(w==null?void 0:w.style)||"",a.style||""],onClick:Qe([A,w==null?void 0:w.onClick]),onMouseenter:Qe([O,w==null?void 0:w.onMouseenter]),onMousemove:Qe([E,w==null?void 0:w.onMousemove])}),i("div",{class:`${e}-base-select-option__content`},C));return a.render?a.render({node:_,option:a,selected:s}):r?r({node:_,option:a,selected:s}):_}}),Ft=x("base-select-menu",`
 line-height: 1.5;
 outline: none;
 z-index: 0;
 position: relative;
