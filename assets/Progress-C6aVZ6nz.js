import{d as B,h as r,aX as W,n as m,bd as j,bb as q,ba as O,bc as G,ci as M,cj as k,H as z,f as a,g as w,j as A,K as T,ck as L,M as X,R as D}from"./index-DeO2nFEY.js";const Y={success:r(G,null),error:r(O,null),warning:r(q,null),info:r(j,null)},_=B({name:"ProgressCircle",props:{clsPrefix:{type:String,required:!0},status:{type:String,required:!0},strokeWidth:{type:Number,required:!0},fillColor:[String,Object],railColor:String,railStyle:[String,Object],percentage:{type:Number,default:0},offsetDegree:{type:Number,default:0},showIndicator:{type:Boolean,required:!0},indicatorTextColor:String,unit:String,viewBoxWidth:{type:Number,required:!0},gapDegree:{type:Number,required:!0},gapOffsetDegree:{type:Number,default:0}},setup(e,{slots:u}){const g=m(()=>{const o="gradient",{fillColor:t}=e;return typeof t=="object"?`${o}-${M(JSON.stringify(t))}`:o});function y(o,t,n,d){const{gapDegree:p,viewBoxWidth:f,strokeWidth:h}=e,l=50,b=0,s=l,i=0,x=2*l,$=50+h/2,v=`M ${$},${$} m ${b},${s}
      a ${l},${l} 0 1 1 ${i},${-x}
